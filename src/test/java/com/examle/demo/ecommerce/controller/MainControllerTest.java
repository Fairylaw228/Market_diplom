...
public class MainControllerTest {
    ...
    public void searchTest() throws Exception {
        ...
        Assertions.assertEquals("Dior", perfumeService.findByPerfumerOrPerfumeTitle(perfume.getPerfumer(), perfume.getPerfumer(), pageable).getContent().get(0).getPerfumer());
    }
